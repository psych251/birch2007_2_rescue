...
-   Exclude participants who are colorblind and/or did not give consent and/or are not college-educated (if pre-screener ends up being not possible/fails)
...
-   Create three-panel graph comparing mean difference in probability judgments for "red container" between the *ignorant* and *knowledge-plausible* groupsacrossthe original study (Birch & Bloom, 2007)*,* 1st replication (Borchers, 2018),and the present study

    -   Include bootstrapped 95% confidence intervals
