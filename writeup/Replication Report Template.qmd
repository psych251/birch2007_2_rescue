...
Given that the survey is estimated to take only a few minutes, and using an hourly pay of \$10, I anticipate it to be feasible to recruit an even larger sample size of *N* = 387 while staying within budget ($N_{planned}*pay = 387*(\frac{10}{60}*3)=194)$).
...
Based on the considerations above, I propose to recruit *N* = 387 participants (*n* = 129 per condition) and terminate data collection thereafter.
