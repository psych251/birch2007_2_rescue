...
![Figure taken from Birch and Bloom (2007); questionnaire item prompting participants to respond by indicating probabilities between 0 and 100. Color-word labels (red, green, purple, blue) are included in the figure for interpretability and were not shown to participants in the study.](images/Screenshot%202023-10-22%20at%2015.20.40.png){fig-align="center"}
...
[Study paradigm on Qualtrics](https://stanforduniversity.qualtrics.com/jfe/form/SV_egPpG0CfiIZAKPk?PROLIFIC_PID=6532e945721c66a08685dbaa&STUDY_ID=6539a3a6f3653a31f4561148&SESSION_ID=03e1hesve6nm)
...
In planning her replication study, [Borchers (2018)](https://rpubs.com/lrborchers/450894) ran an a-priori power analysis and reported that "\[we\] would need 24 participants per condition to achieve 80% power, 32 participants per condition to achieve 90% power, and 40 participants per condition to achieve 95% power."
...
1.  Read in csv. data in R (deidentified data set available under <https://github.com/psych251/birch2007_2_rescue/tree/main/data>)
...
3.  Exclude participants whose probability estimates did not sum up to (roughly) 100% (± 5%).
...
After the above exclusions, the final *N* for analysis was 374. The total *n* per condition was not affected systematically.
...
1.  Comparison of participants' probability judgments for the "red" container between the *ignorance* and *knowledge-implausible* groups
...
2.  Comparison of participants' probability judgments for the "blue" container between the *ignorance* and *knowledge-plausible* groups
...
3.  Comparison of participants' probability judgments for the "blue" container between the *ignorance* and *knowledge-implausible* groups
...
4.  Comparison of participants' probability judgments for the "purple" container between the *ignorance* and *knowledge-implausible* groups
...
![](images/Screenshot 2023-12-12 at 19.07.18.png)
...
It should also be noted that relative to Birch and Bloom's (2007) original results, participants also generally judged it more probable for Vicky to first search in the "green" or "purple" containers. In the present study, descriptive statistics showed $M_{green}$ = 7.3% and $SD_{green}$ = 9.8% as well as $M_{purple}$ = 8.8% and $SD_{purple}$ = 13.2%. In the original study, descriptive statistics showed $M_{green}$ = 3.3% and $SD_{green}$, as well as $M_{purple}$ = 3.7% and $SD_{purple}$ = 6.3%. This is slightly surprising, given that the story context should render these search locations as quite improbable: Both containers are neither of the same color as the container where Vicky placed her violin (blue), nor do they inhabit the same location of the original container after the sister, Denise, had rearranged the room. While this need not have impeded on the estimation of the effect of interest, it is still a deviation from the original results.

Importantly, all of the above is still consistent with the explanation that *some* but not all adults in the *knowledge-plausible* condition may have succumbed to a "curse of knowledge" bias under the circumstances leveraged in the present study. The effect size, indeed, was not zero (*d* = 0.09), though drastically smaller than the one estimated in the original study (*d* = .47). Still, this difference in effect size could, at least in part, be explained by sampling variability as well as the discrepancies in study setup (lab versus in-person). Hence, Birch and Bloom's (2007) fundamental claim that adults may display difficulties in their false-belief reasoning if sensitive enough measures are used should not be dismissed entirely on the basis of the present study's results. Rather thano asking whether or not the "curse of knowledge" is a true phenomenon, the key question then becomes: To what degree, and under which circumstances, if not the ones induced in the present study, do adults display difficulties in false-belief reasoning akin to those of children? Future research may wish to develop and employ new, adapted paradigms to investigate this question.
...
Bridgers, S. (n.d.). Replication of \'The Curse of Knowledge in Reasoning about False Beliefs\'  by Susan A.J. Birch & Paul Bloom (2007, Psychological Science). Google Docs. Retrieved on December 12, 2023, from <https://docs.google.com/document/d/1fSARliH5QKadGy3UElC00ehgwr2LLQbey-uzb1RPv0A/edit?usp=embed_facebook>
